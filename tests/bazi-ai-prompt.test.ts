...
test('八字主提示词不再区分简洁模式，统一由同一套系统规则驱动', () => {
  ...
  assert.match(aiPromptsSource, /buildPromptSection\('解读范围'/);
